...
import com.phicomm.speaker.device.ui.MainTestActivity;
...
public class MainTestActivity$$ViewBinder<T extends MainTestActivity> implements ButterKnife.ViewBinder<T> {
    ...
    public void bind(ButterKnife.Finder finder, final T target, Object source) {
        ...
        view.setOnClickListener(new DebouncingOnClickListener() { // from class: com.phicomm.speaker.device.ui.MainTestActivity$$ViewBinder.1
        ...
        view2.setOnClickListener(new DebouncingOnClickListener() { // from class: com.phicomm.speaker.device.ui.MainTestActivity$$ViewBinder.2
            @Override // butterknife.internal.DebouncingOnClickListener
            public void doClick(View p0) {
                target.onClick(p0);
            }
        ...
        view3.setOnClickListener(new DebouncingOnClickListener() { // from class: com.phicomm.speaker.device.ui.MainTestActivity$$ViewBinder.3
            @Override // butterknife.internal.DebouncingOnClickListener
            public void doClick(View p0) {
                target.onClick(p0);
            }
        ...
        view4.setOnClickListener(new DebouncingOnClickListener() { // from class: com.phicomm.speaker.device.ui.MainTestActivity$$ViewBinder.4
            @Override // butterknife.internal.DebouncingOnClickListener
            public void doClick(View p0) {
                target.onClick(p0);
            }
        ...
        view5.setOnClickListener(new DebouncingOnClickListener() { // from class: com.phicomm.speaker.device.ui.MainTestActivity$$ViewBinder.5
            @Override // butterknife.internal.DebouncingOnClickListener
            public void doClick(View p0) {
                target.onClick(p0);
            }
        ...
        view6.setOnClickListener(new DebouncingOnClickListener() { // from class: com.phicomm.speaker.device.ui.MainTestActivity$$ViewBinder.6
            @Override // butterknife.internal.DebouncingOnClickListener
            public void doClick(View p0) {
                target.onClick(p0);
            }
