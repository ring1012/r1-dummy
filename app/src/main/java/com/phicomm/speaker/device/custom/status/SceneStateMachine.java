...
public class SceneStateMachine extends StateMachine {
    ...
    private State mDossState;
    private State mEnteringBluetoothState;
    private State mEnteringDossState;
    private State mEnteringMusicState;
    private State mEnteringNetConfigState;
    private State mExitingBluetoothState;
    private State mExitingDossState;
    private State mExitingMusicState;
    private State mExitingNetConfigState;
    private State mMusicState;
    private State mNetConfigState;
    ...
    public SceneStateMachine(Context context) {
        ...
        this.mNetConfigState = new NetConfigState();
        this.mBluetoothState = new BluetoothState();
        this.mDossState = new DossState();
        this.mEnteringDossState = new EnteringDossState();
        this.mExitingDossState = new ExitingDossState();
        this.mEnteringMusicState = new EnteringMusicState();
        this.mExitingMusicState = new ExitingMusicState();
        this.mEnteringNetConfigState = new EnteringNetConfigState();
        this.mExitingNetConfigState = new ExitingNetConfigState();
        this.mEnteringBluetoothState = new EnteringBluetoothState();
        this.mExitingBluetoothState = new ExitingBluetoothState();
    ...
    class ReadyState extends SteadyState {
        ...
        @Override // com.phicomm.speaker.device.custom.status.SceneStateMachine.SteadyState, com.android.internal.util.State, com.android.internal.util.IState
        public void enter() {
    ...
    class EnteringMusicState extends EnteringIntermediateState {
        ...
        @Override // com.phicomm.speaker.device.custom.status.SceneStateMachine.IntermediateState, com.android.internal.util.State, com.android.internal.util.IState
        public boolean processMessage(Message msg) {
    ...
    class IntermediateState extends State {
        private Runnable mTimeoutRunnable = new Runnable() { // from class: com.phicomm.speaker.device.custom.status.SceneStateMachine.IntermediateState.1
