...
public class HardwareParameters implements UplinkData {
    ...
    public void setDeviceType(@Nullable String deviceType2) {
    ...
    public void setDeviceNetState(@Nullable DeviceNetState deviceNetState2) {
        this.deviceNetState = deviceNetState2;
    }
}
