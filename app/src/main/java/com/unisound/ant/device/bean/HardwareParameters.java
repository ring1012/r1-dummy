...
import com.unisound.ant.device.devicelayer.DeviceNetState;
import com.unisound.vui.common.UplinkData;
import java.util.List;

/* loaded from: classes.dex */
public class HardwareParameters implements UplinkData {
    ...
    @SerializedName("deviceNetState")
    @Nullable
    @JSONField(name = "deviceNetState")
    DeviceNetState deviceNetState;
    ...
    public void setTotalMemory(@Nullable String totalMemory) {
    ...
    public void setAvailableMemory(@Nullable String availableMemory) {
    ...
    public void setCpuSize(@Nullable String cpuSize) {
    ...
    public void setOtherSensor(@Nullable List<String> otherSensor) {
        this.otherSensor = otherSensor;
    }

    @Nullable
    public DeviceNetState getDeviceNetState() {
        return this.deviceNetState;
    }

    public void setDeviceNetState(@Nullable DeviceNetState deviceNetState) {
        this.deviceNetState = deviceNetState;
    }
}
