...
public class WifiConnect {
    ...
    private boolean openWifi() {
        ...
        boolean bRet = this.wifiManager.setWifiEnabled(true);
        return bRet;
    }

    public int connect(String ssid, String password, WifiCipherType type) throws InterruptedException {
        if (!openWifi()) {
    ...
    public String getScanResult(String ssid) throws InterruptedException {
        String ss = null;
        int count = 1;
