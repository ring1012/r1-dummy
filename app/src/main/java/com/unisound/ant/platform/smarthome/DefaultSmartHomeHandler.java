...
public class DefaultSmartHomeHandler extends SimpleUserEventInboundHandler<NLU> {
    ...
    private Handler taskHandler = new Handler() { // from class: com.unisound.ant.platform.smarthome.DefaultSmartHomeHandler.1
    ...
    public boolean acceptInboundEvent0(NLU evt) throws Exception {
        ...
        return super.acceptInboundEvent0((DefaultSmartHomeHandler) evt);
    }
    ...
    public void eventReceived(NLU evt, ANTHandlerContext ctx) throws Exception {
        super.eventReceived((DefaultSmartHomeHandler) evt, ctx);
        String answer = null;
