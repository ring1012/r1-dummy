...
public final class UserPerferenceUtil {
    ...
    public static List<String> getCmopetitionWord(Context context) throws Resources.NotFoundException {
    ...
    public static List<String> getDefaultWakeupWord(Context context) throws Resources.NotFoundException {
        ArrayList arrayList = new ArrayList();
    ...
    public static ArrayList<String> getMusicOprlWakeupWord(Context context) throws Resources.NotFoundException {
    ...
    private static List<String> getNavigationWakeupWord() {
        ...
        Iterator<String> it = NaviConfig.naviSuportWakeUpWords.iterator();
        while (it.hasNext()) {
            arrayList.add(it.next());
        }
        return arrayList;
    ...
    public static ArrayList<String> getSceneModeControlWakeupWord(Context context) throws Resources.NotFoundException {
        ArrayList<String> arrayList = new ArrayList<>();
    ...
    public static String getValidSdk(Context context) {
        ...
        long sdkTokenValidTime = ((getSdkTokenValidTime(context) * 1000) / 2) + sdkTokenUpdateTime;
        long jCurrentTimeMillis = System.currentTimeMillis();
        LogMgr.d("SdkVeri", "now:" + jCurrentTimeMillis + "validTime:" + sdkTokenValidTime + "upDateTime:" + sdkTokenUpdateTime);
        if (sdkTokenValidTime > jCurrentTimeMillis) {
            return sdkToken;
        }
        return null;
    }
    ...
    public static void setEffectiveWakeupword(List<String> wakeupwords, Context context) {
        HashSet hashSet = new HashSet();
        Iterator<String> it = wakeupwords.iterator();
        while (it.hasNext()) {
            hashSet.add(it.next());
        }
