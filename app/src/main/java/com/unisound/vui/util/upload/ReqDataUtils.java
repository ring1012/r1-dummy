...
public class ReqDataUtils {
    ...
    public static String decoder(String cipherText) {
        DecodeResult decodeResultDecode = ReqDataDecoder.decode(Base64.decode(cipherText.getBytes(), 0));
        return new String(decodeResultDecode != null ? decodeResultDecode.getOther() : new byte[0]);
    }
