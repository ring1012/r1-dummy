...
public class DefaultUserANTEOptionProvider implements a {
    ...
    public Map<ANTEngineOption<?>, Object> options() {
        ...
        linkedHashMap.put(ANTEngineOption.ASR_OPT_PRINT_TIME_LOG, false);
        linkedHashMap.put(ANTEngineOption.ASR_OPT_PRINT_LOG, true);
        linkedHashMap.put(ANTEngineOption.ASR_OPT_PRINT_ENGINE_LOG, true);
