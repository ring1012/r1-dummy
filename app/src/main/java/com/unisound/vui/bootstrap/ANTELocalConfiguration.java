...
public final class ANTELocalConfiguration {
    ...
    public static final class LocalRecognition {
        ...
        public LocalRecognition(String grammerPath, String compileJsgfPath, String localNluPath) {
            this.grammerPath = grammerPath;
            this.compileJsgfPath = compileJsgfPath;
            this.localNluPath = localNluPath;
        }
        ...
        public LocalRecognition setCompileJsgfPath(String compileJsgfPath) {
            this.compileJsgfPath = compileJsgfPath;
            return this;
        }

        public LocalRecognition setGrammerPath(String grammerPath) {
            this.grammerPath = grammerPath;
            return this;
        }

        public LocalRecognition setLocalNluPath(String localNluPath) {
            this.localNluPath = localNluPath;
            return this;
        }
    }
    ...
    public void setLocalConfiguration(HashMap<String, LocalRecognition> localConfiguration) {
