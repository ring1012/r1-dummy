...
import com.unisound.vui.handler.session.music.R;
...
public class ANTMediaplayer implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnBufferingUpdateListener, MusicPlayer {
    ...
    private ANTMediaplayer(Context context) {
    ...
    public void onPrepared(MediaPlayer player) throws IllegalStateException {
    ...
    @Override // com.unisound.vui.handler.session.music.player.MusicPlayer
    public void play(String url, boolean playWhenReady) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
