...
public final class ANTEngineOption<T> extends com.unisound.vui.util.a<ANTEngineOption<T>> {
    private static final c<ANTEngineOption<Object>> POOL = new c<ANTEngineOption<Object>>() { // from class: com.unisound.vui.engine.ANTEngineOption.1
        /* JADX INFO: Access modifiers changed from: protected */
        @Override // com.unisound.vui.util.c
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public ANTEngineOption<Object> b(int i, String str) {
            return new ANTEngineOption<>(i, str);
        }
    };
    ...
    private ANTEngineOption(int id, String name) {
        super(id, name);
    }
    ...
    public static <T> ANTEngineOption<T> newInstance(String name) {
        return (ANTEngineOption) POOL.c(name);
    }

    public static <T> ANTEngineOption<T> valueOf(Class<?> firstNameComponent, String secondNameComponent) {
        return (ANTEngineOption) POOL.a(firstNameComponent, secondNameComponent);
    }

    public static <T> ANTEngineOption<T> valueOf(String name) {
        return (ANTEngineOption) POOL.a(name);
    }
