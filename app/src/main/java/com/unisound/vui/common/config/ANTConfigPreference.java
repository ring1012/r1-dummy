...
import com.unisound.vui.common.config.a;
...
public class ANTConfigPreference {
    ...
    public static int oneshotAsrVadTimeoutBackSil = cn.yunzhisheng.asr.a.U;
    public static int wakeupVadTimeoutBackSil = 200;
    public static int oneshotVadBackSil = 1000;
    public static int oneshotWakeupVadTimeoutBackSil = cn.yunzhisheng.asr.a.U;
    ...
    public static void init(Context context) throws IOException {
        a.a(context);
        initPreference();
        a.a(new a.InterfaceC0010a() { // from class: com.unisound.vui.common.config.ANTConfigPreference.1
        });
    }
