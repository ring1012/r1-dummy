...
public class a {
    ...
    public static final int f26a = 10000;
    ...
    public boolean P() {
        try {
            return Integer.parseInt(this.N.f27a) == 1;
        } catch (Exception e2) {
            e2.printStackTrace();
            return false;
        }
    ...
    public float Q() {
        try {
            return Float.parseFloat(this.O.f27a);
        } catch (Exception e2) {
            e2.printStackTrace();
            return 0.0f;
        }
    ...
    public void a(byte[] bArr, String str) throws Throwable {
        if (this.c != null) {
            this.c.a(bArr, str);
        }
    }
    ...
    public int ad() {
        if (this.c != null) {
            return this.c.s() ? this.c.c() : this.c.b();
        }
        return 0;
    }
    ...
    public int ai() {
        y.c("current Recording Length is " + this.bb);
        return this.bb;
    }
